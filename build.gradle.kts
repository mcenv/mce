    ...
    sourceSets {
        ...
        val clientMain by getting {
            dependencies {
                ...
                implementation("io.ktor:ktor-client-core:2.0.0-eap-362")
                implementation("io.ktor:ktor-client-js:2.0.0-eap-362")
                implementation("io.ktor:ktor-client-websockets:2.0.0-ide-debug-eap-225")
            }
        }
