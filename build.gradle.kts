    ...
    sourceSets {
        ...
        val clientMain by getting {
            dependencies {
                ...
                implementation("io.ktor:ktor-client-core:2.0.1-eap-378")
                implementation("io.ktor:ktor-client-js:2.0.1-eap-378")
                implementation("io.ktor:ktor-client-websockets:2.0.1-eap-382")
            }
        }
