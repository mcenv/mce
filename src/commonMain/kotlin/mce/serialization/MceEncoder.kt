...
class MceEncoder(private val output: ByteArrayOutputStream) : Encoder, CompositeEncoder {
    ...
    override fun beginCollection(descriptor: SerialDescriptor, collectionSize: Int): CompositeEncoder = apply { output.writeInt(collectionSize) }
    ...
    override fun <T> encodeSerializableElement(descriptor: SerialDescriptor, index: Int, serializer: SerializationStrategy<T>, value: T): Unit = serializer.serialize(this, value)
