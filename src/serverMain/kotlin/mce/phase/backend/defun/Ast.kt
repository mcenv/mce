...
sealed class Term {
    ...
    data class BoxOf(val content: Term, val tag: Term, override val type: VTerm) : Term()
    ...
    data class Box(val content: Term, override val type: VTerm) : Term()
...
sealed class Pat {
    ...
    data class BoxOf(val content: Pat, val tag: Pat, override val type: VTerm) : Pat()
    ...
    data class And(val variants: KList<Pat>, override val type: VTerm) : Pat()
    data class Unit(override val type: VTerm) : Pat()
    data class Bool(override val type: VTerm) : Pat()
    data class Byte(override val type: VTerm) : Pat()
    data class Short(override val type: VTerm) : Pat()
    data class Int(override val type: VTerm) : Pat()
    data class Long(override val type: VTerm) : Pat()
    data class Float(override val type: VTerm) : Pat()
    data class Double(override val type: VTerm) : Pat()
    data class String(override val type: VTerm) : Pat()
    ...
    data class Box(val content: Pat, override val type: VTerm) : Pat()
