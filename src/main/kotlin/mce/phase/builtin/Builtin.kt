package mce.phase.builtin

import mce.phase.Normalizer
import mce.phase.backend.pack.Command
import mce.phase.builtin.src.identity
import mce.phase.frontend.elab.VTerm
import mce.phase.builtin.src.byte_array.size as byte_array_size
import mce.phase.builtin.src.int.add as int_add
import mce.phase.builtin.src.int.div as int_div
import mce.phase.builtin.src.int.eq as int_eq
import mce.phase.builtin.src.int.mod as int_mod
import mce.phase.builtin.src.int.mul as int_mul
import mce.phase.builtin.src.int.ne as int_ne
import mce.phase.builtin.src.int.sub as int_sub
import mce.phase.builtin.src.int_array.size as int_array_size
import mce.phase.builtin.src.list.size as list_size
import mce.phase.builtin.src.long_array.size as long_array_size
